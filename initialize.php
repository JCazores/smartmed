...
if(!defined('DB_SERVER')) define('DB_SERVER', 'acela.proxy.rlwy.net');
if(!defined('DB_PORT')) define('DB_PORT', 58509);
if(!defined('DB_USERNAME')) define('DB_USERNAME', 'root');
if(!defined('DB_PASSWORD')) define('DB_PASSWORD', 'oCZnrPaBlUHwYSSosvPTWAFRnKiSwQJI');
if(!defined('DB_NAME')) define('DB_NAME', 'smart_med');
?>