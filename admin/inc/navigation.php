        ...
        <div class="sidebar">
            ...
            <nav class="mt-4">
                ...
                <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
    <a href="<?php echo base_url ?>admin/?page=patients/view_patient&id=<?php echo $_settings->userdata('id'); ?>" class="nav-link nav-patients" style="color: white; border-radius: 25px">
