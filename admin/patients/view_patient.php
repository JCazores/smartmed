...
if (isset($_GET['id'])) {
    ...
    // Query the database to get patient details using the id
    ...
    if ($qry->num_rows > 0) {
        ...
        // Fetch additional patient details from the 'patient_details' table
...
// Fetch doctors and rooms related to the patient
$doctors_arr = [];
...
<div class="content py-3">
    <div class="card card-blue card-outline shadow rounded-0">
        ...
        <div class="card-body rounded-0">
            <div class="container-fluid">
                <fieldset>
                    <div class="row">
                        <div class="col-4 border bg-gradient-primary text-white"style="padding: 5px">Patient Code</div>
                        <div class="col-8 border" style="padding: 5px"><?= isset($code) ? $code : '' ?></div>
                        <div class="col-4 border bg-gradient-primary text-white" style="padding: 5px">Patient Fullname</div>
                        <div class="col-8 border" style="padding: 5px"><?= isset($fullname) ? $fullname : '' ?></div>
                        <div class="col-3 border bg-gradient-primary text-white" style="padding: 5px">Age</div>
                        <div class="col-3 border" style="padding: 5px"><?= isset($age) ? $age : '' ?></div>
                        <div class="col-3 border bg-gradient-primary text-white" style="padding: 5px">Weight</div>
                        <div class="col-3 border" style="padding: 5px"><?= isset($weight) ? $weight : '' ?> Kg</div>
                        <div class="col-3 border bg-gradient-primary text-white" style="padding: 5px">Gender</div>
                        <div class="col-3 border" style="padding: 5px"><?= isset($gender) ? $gender : '' ?></div>
                        <div class="col-3 border bg-gradient-primary text-white" style="padding: 5px">Birthday</div>
                        <div class="col-3 border" style="padding: 5px"><?= isset($dob) ? date("M d, Y", strtotime($dob)) : '' ?></div>
                        <div class="col-3 border bg-gradient-primary text-white" style="padding: 5px">Address</div>
                        <div class="col-9 border" style="padding: 5px"><?= isset($address) ? $address : '' ?></div>
                    </div>
                </fieldset>
                <br>
                <div class="row">
                    <div class="col-md-6">
                        <fieldset>
                            <legend class="text-primary border-bottom">Medical History</legend>
                            ...
                            <table class="table table-striped table-bordered"  style="padding: 20px">
                                ...
                                <thead>
                                    <tr class="bg-gradient-dark">
                                        <th class="px-2 py-1">Date of Diagnosis</th>
                    ...
                    <div class="col-md-6">
                    <fieldset>
                            <legend class="text-primary border-bottom">Confinement History</legend>
                            <?php if($_settings->userdata('type') == 1): ?>
                            <div class="col-12 text-right">
    ...
    <!-- Confinement Table -->
    <div id="confinement-table" class="content-table">
        <table class="table table-striped table-bordered">
            ...
            <thead>
                <tr class="bg-gradient-dark">
                    <th class="px-2 py-1">Admit Date</th>
